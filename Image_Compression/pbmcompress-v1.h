...
/*
 * This is a debugger flag spread throughout each .cpp file.
 * If set to true, this means more will print to help show bugs, and if this
 * is set to false, this will not be in debug mode, and code will complete without
 * print statements.
 */
